...
class CafeForm(FlaskForm):
    ...
    close = StringField('Close Time',validators=[InputRequired()])
    coffee = StringField('coffe rating',validators=[InputRequired()])
    wifi_rating = StringField('coffe rating',validators=[InputRequired()])
    power_rating = StringField('power outlet rating',validators=[InputRequired()])
